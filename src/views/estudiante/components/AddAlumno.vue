  ...
  <FullModal @close="close">
    ...
    <template v-slot:body>
      ...
      <div v-else>
        <div v-if="tab === 'options'">
          <h5 class="font-weight-bolder mb-0 fuente mt-1">
          ...
          <div class="w-70">
            <span class="parrafo">Agregar direccion de correo</span>
            <input v-model="model.email" class="multisteps-form__input form-control buscador fuente" type="email"
              @input="onChange" />
          </div>
          <div class="mt-4">
            <hr />
            <h5 class="font-weight-bolder mb-0 fuente mt-2">
              ...
              <div class="csvv w-50 text-center mt-3" style="max-width: 200px;">
                <a href="javascript:;" @click="openInport()" style="padding:10px;">
                  <img class="w-75" src="../../../assets/img/logs/hoja.svg" alt="fondo" />
                  <p style="font-size: 16px;" class="fuente mt-3">
                    Archivo TXT
                  </p>
                  <span class="fuente text-xs">Carga un archivo TXT o un archivo de texto simple en
                    formato TXT</span>
                </a>
              </div>
        ...
        <form @submit.prevent="save" id="estidiantes">
          <div v-if="tab === 'sec3'">
            <div class="d-flex px-2 py-1 ">
              <div>
                <img src="https://res.cloudinary.com/stebann/image/upload/v1634918496/default-100_namn33.webp"
                  class="avatar avatar-xl me-3" alt="avatar image" style="border-radius: 50%;" />
              </div>
              <div class="d-flex flex-column justify-content-center">
                <b class="mb-0 h5  fuente" style="color: #33475b;font-weight: 400;">{{ model.email }}</b>
                <div>
                  <span class="UIStatusDot-sc-1axnt8y-0 cqKvgt"></span>
                  <span class="text-xs text-center font-weight-normal fuente">Usuario de sistema</span>
                </div>
              </div>
            </div>
            <span class="parrafo mt-1">Número de Cédula</span>
            <input v-model="model.cedula" @change="__validarCedula($event)" class=" form-control buscador "
              type="text" />
    ...
    <template v-slot:footer>
      ...
      <div v-if="tab === 'sec3'">
        ...
        <button v-else type="submit" class="btn btnNaranja" form="estidiantes">{{model._id ? " Actualizar" : "Guardar"
        }}
        </button>
      </div>
