<template>
    <div>
      <AlertHeader :initText="'Regresar'" :firsttext="'Zonas'" :lasttext="'Registro etnias'" ></AlertHeader>
       <p class="parrafo mt-3">Crea nuevos registros, edita y elimina las etnias.</p>
