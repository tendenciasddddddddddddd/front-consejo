<template>
    <div >
       <AlertHeader :initText="'Regresar'" :firsttext="'Zonas'" :lasttext="'Registro nacionalidad'" ></AlertHeader>
       <p class="parrafo mt-3">Crea nuevos registros, edita y elimina la nacionalidad.</p>
