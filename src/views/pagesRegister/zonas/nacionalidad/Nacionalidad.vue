        ...
        >
          <div>
            <p class="text-dark fuente " style="margin:7px;font-weight: 700; font-size: 16px ">
             <router-link to="/option-zonas" class="badge fuente regresar" style=""> 
               <i class="ni ni-bold-left"></i>&nbsp;Regresar</router-link>
              &nbsp;&nbsp;    &nbsp;&nbsp;  Los regitros van en cascada Nacionalidad.
            </p>
          </div>
        </div>
       <p class="parrafo mt-2">Crea nuevos registros, edita y elimina la nacionalidad.</p>
      <div class="card">
        <!-- Card header -->
        <div class="mt-1">
          <div class="row ">
                ...
                <div class="modal-body">
                  <form @submit.prevent="save" role="form text-left">
                    ...
                    <div class="form-check form-check-info text-left">
                      <a class="parrafo">{{ model.estado ? "Estado" : "Active Estado" }}</a>
                      <input
