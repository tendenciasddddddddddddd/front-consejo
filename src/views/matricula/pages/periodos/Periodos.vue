          ...
          <div v-else class="table-responsive ">
            <table class="dataTable-table table s-table-flush">
              <thead class="thead-light">
                <tr class="cabeza">
                  <th style="background-color: rgb(234, 240, 249); ">
                ...
                <tr v-for="item in info" :key="item.id">
                  ...
                  <td>
                    <div class="form-check mb-1">
                      <input class="form-check-input" v-model="checkeds" type="radio" name="item.estado"
                        :id="item.estado" :value="item.estado" @click="selectEstado(item._id, item.estado)" />
                    </div>
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    ...
    remove() {
      this.toast("NO PUEDE ELIMINAR LOS PERIODOS ACADÉMICOS ");
    },
    dialogDelete() {
