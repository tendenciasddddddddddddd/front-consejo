  ...
  <div class="row">
    <div class="col-lg-11 col-12 mx-auto">
      <a
        ...
        style="box-shadow: none;padding: 0rem 0em !important;margin-bottom: 0px !important;"
      >
        <i class="bx bx-left-arrow-alt icono-regresar"></i>
      </a>
      <span class="titulo-principla">
        <span class="text-azul me-1">Extraordinaria</span> Unir a docentes con
        paralelos cursos y materias.
      </span>

      <p class="parrafo mt-1">
        Crea nuevos registros, edita y elimina los distributivos.
      </p>
          ...
          <div class="col-lg-3">
            <div class="input-group">
              <span class="input-group-text text-body buscador">
                <i class="bx bx-search colorhs" style="font-size: 22px;"></i>
              </span>
              <input
                type="text"
                ...
                <tbody>
                  <tr v-for="item in info" :key="item.id">
                      ...
                      <div class="d-flex ms-3">
                        ...
                        <div class="mb-0 ms-3 text-xs colorestabla fuente">
                          ...
                          <div>
                            ...
                            ></span>
                            Materia :
                            <span v-if="item.fmateria"
                              >{{ item.fmateria.nombre }}
                            </span>
                            <span v-else class="text-danger "
                              >Elimine este resgistro</span
                            >
                    ...
                    <td class="text-sm text-center text-dark fuente">
                      ...
                      <span v-else class="text-danger "
                        >Elimine este resgistro es inestable</span
                      >
                    </td>
                  </tr>
                </tbody>
    ...
    <div class="fixed-plugin" :class="{ 'show reponv1': tab === 'init1' }">
      ...
      >
        ...
        <div class="card-body pt-sm-3 pt-0">
          <!-- Sidebar Backgrounds -->
          <p class="h5 fuente mt-3">
            Vincular docentes con paralelos y materias
          </p>
          ...
          <form v-else @submit.prevent="save" id="dist1">
            ...
            <v-select
              class="style-chooser"
              placeholder="Selecionar paralelo"
        ...
        <div class="cord-footer modalFooter">
          <div class="text-end">
            <a class="btn btnNaranjaClaro" @click="__limpiarCampos()">
              Limpiar
            </a>
