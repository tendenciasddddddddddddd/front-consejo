        ...
        children: [
          ...
          { field: "a5", headerName: 'Insumo 5', editable: true, columnGroupShow: 'open', valueFormatter: saleValueFormatter, },
          {
            ...
            valueGetter: params => {
              ...
              let a1 = parseFloat(p1)==0? 0.001: parseFloat(p1),  a2 = parseFloat(p2)==0? 0.001: parseFloat(p2), 
              a3 = parseFloat(p3)==0? 0.001: parseFloat(p3), a4 = parseFloat(p4)==0? 0.001: parseFloat(p4), a5 = parseFloat(p5)==0? 0.001: parseFloat(p5)
              let suma = 0;
              let promedio = 0;
              let aux = 0;
              if(a1!=''&&a2!=''&&a3!=''&&a4!=''&&a5!=''){
        ...
        children: [
          ...
          { field: "x5", headerName: 'Insumo 5', editable: true, columnGroupShow: 'open', valueFormatter: saleValueFormatter, },
          {
            ...
            valueGetter: params => {
              ...
              let a2 = parseFloat(p2)==0? 0.001: parseFloat(p2)
              let p3 = params.data.x3.toString().replace(",", ".")
              let a3 = parseFloat(p3) ==0? 0.001: parseFloat(p3)
              let p4 = params.data.x4.toString().replace(",", ".")
              let a4 = parseFloat(p4)==0? 0.001: parseFloat(p4)
              let p5 = params.data.x5.toString().replace(",", ".")
              let a5 = parseFloat(p5)==0? 0.001: parseFloat(p5)
              let suma = 0;
              let promedio = 0;
              let aux = 0;
              if(a1!=''&&a2!=''&&a3!=''&&a4!=''&&a5!=''){
