                            ...
                            <div class=" text-center ">
                                <div class="row justify-content-between">
                                    <div class="col-md-1 text-start">
                                        <img class=" w-100 " :src="settings.logo" alt="Logo" />
                                    </div>
                                    <div class="col-md-11">
                                            ...
                                            <table class="dataTable-table table s-table-flush "
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 1px 3px;border-top: 1px solid rgb(223 227 235);"
                                                            class="mb-0 ms-3 text-start text-xxs negros "><span
                                                                v-if="parcial">EX</span></td>
                                                        <td style="padding: 1px 3px;border-top: 1px solid rgb(223 227 235);"
                                                            class="mb-0 ms-3 text-start text-xxs negros"><span
                                                                v-if="parcial2">EX</span> </td>
                                                        <td style="padding: 1px 3px;border-top: 1px solid rgb(223 227 235);"
                                                            class="mb-0 ms-3 text-start text-xxs negros fuente">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 1px 3px;"
                                                            ...
                                                            COMPORTAMIENTO </td>
                                                        <td style="padding: 1px 3px;"
                                                            class="mb-0 ms-3 text-start text-xxs negros fuente"> <span
                                                                v-if="parcial">A</span> </td>
                                                        <td style="padding: 1px 3px;"
                                                            class="mb-0 ms-3 text-start text-xxs negros fuente">
