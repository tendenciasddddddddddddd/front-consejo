    ...
    <FullModal @close="close">
      ...
      <template v-slot:body>
        <form @submit.prevent="save" id="task">
                                  <a v-if="detalleTask" :href="detalleTask" target="_blank" class=" btn btnNaranja" style=" padding: 10px !important;" >
                                     <span >Mostrar archivo cargado</span>
                                  </a>
            <p class="text-sm negros">Nombre de Tarea</p>
    ...
    methods: {
      ...
      initial() {
        if (this.collects._id != undefined) {
          ...
          this.detalleTask = this.collects.archivo;
