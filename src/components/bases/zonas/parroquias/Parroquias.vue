          ...
          <div>
            <p class="text-dark fuente " style="margin:7px;font-weight: 700; font-size: 16px ">
             <router-link to="/MenuZonas" class="badge fuente regresar" style=""> 
              ...
              &nbsp;&nbsp;    &nbsp;&nbsp;  Los regitros van en cascada Parroquias.
            </p>
          </div>
        </div>
       <p class="parrafo mt-2">Crea nuevos registros, edita y elimina las parroquias.</p>
      <div class="card">
        <!-- Card header -->
        <div class="mt-1">
          <div class="row ">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form v-else @submit.prevent="save" role="form text-left">
                    ...
                    <v-select v-else :options="listprov" label="nombre" v-model="model.fkCanton">
