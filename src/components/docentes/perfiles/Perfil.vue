      ...
      >
        <div>
          <p class="text-sm text-dark parrafo" style="margin:7px; ">
            ...
            cuenta y otras personas del sistema pueden compartir esta
      ...
      >
        ...
        >
          <div class="float-start">
            <h3 style="font-weight: 400;" class="mt-3 mb-0 fuente">
              Edita Tu perfil
            </h3>
                  ...
                  <div class="row mt-3">
                    <div class="col-sm-6">
                      ...
                      <p class="mb-0 text-sm text-danger">
                       ...
                       <p class="parrafo mt-3">Titulo</p>
                      <!-- <p class="form-text text-muted text-xs ms-1 d-inline">
                  (optional)
                </p> -->
                      <textarea
                        :class="{ error: validation.hasError('model.titulo') }"
                        v-model="model.titulo"
                        class="form-control"
                      >
                      </textarea>
                      <p class="mb-0 text-sm text-danger">
                        {{ validation.firstError("model.titulo") }}
                      </p>
                    </div>
                    <div class="col-sm-6">
