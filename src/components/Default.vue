<template>
  <div >
      <h1 aria-label="Develop. Preview. Ship." class="hero_title__HaAVy"><span
          ...
          style="--content:'UEL';--padding:0.05em;--start-color:#FF4D4D;--end-color:#F9CB28"><span
            class="animated-gradient-text_foreground__kb6tN animated-gradient-text_foreground-3__kum5b">UEL</span></span>
      </h1>
      <!-- <div class="text-end">
