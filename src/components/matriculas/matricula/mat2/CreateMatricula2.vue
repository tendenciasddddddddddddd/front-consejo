      ...
      >
        ...
        >
          <div class="float-start">
            <h4 class="mt-3 mb-0 text-dark fuente" style="font-weight: 400;">Matricula Extraordonaria</h4>
          </div>
                    ...
                    <div class="row mt-4">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <p class="parrafo">
                            Para que estudiante pueda gentioner sus recursos
                            tiene que activar el estado
                          </p>
    ...
    border-width: 1px;">Cancelar</a> &nbsp;&nbsp;&nbsp;
                  ...
                  <div class="row">
                    ...
                    <div class="mt-4">
                     ...
                     <div>
                        <div class="mt-4">
                         <router-link to="/Matricula-2" class="btn btn-sm" style="background-color: #fff;
                      border-color: #ff7a59; color: #ff7a53; font-weight: 500; border-radius: 3px;
    border-style: solid;
