<template>
  <div>
    <div class="row mb-5">
      <Navss :actualText="'Estudiantes Intensivo'" :rutas="rutass"></Navss>
      <div class="col-lg-9  mt-4 ">
        <!-- Card Profile -->

        <div class=" h-100 " id="accounts">
          <div class="card-body ">
            <div class="row">
               <div class="col-lg-8">
                    <img
                        class="w-100"
                        src="../../../../assets/img/shapes/Checking.gif"
                        alt="vuejs"
                      />
               ...
               <div class="col-lg-4">
                  <div class="mt-8">
                      <router-link to="/Create-Matricula-v1" type="button" class="btn btn-lg " style="background-color: #ff7a59;
    ...
    border-width: 1px;">
      ...
      <div class="col-lg-3  mt-4">
        <div class=" position-sticky top-1 h-100">
          <ul class="nav flex-column bg-white border-radius-lg p-3">
            <li class="nav-item pt-2">
              ...
              >
                ...
                <span class="text-sm fuente">Lista Matriculados</span>
              </router-link>
            </li>

            <li class="nav-item pt-2">
              <router-link
                to="/Lista-Paralelo-v1"
                class="nav-link text-body"
                data-scroll=""
                href="#2fa"
              >
                ...
                <span class="text-sm fuente">Asignar Paralelos</span>
              </router-link>
            </li>
            <li class="nav-item pt-2">
              <a
              ...
              >
                ...
                <span class="text-sm fuente">Todas las Matriculas</span>
              </a>
            </li>
            <li class="nav-item pt-2">
              <a
              ...
              >
                ...
                <span class="text-sm fuente">Enviar Emails</span>
              </a>
            </li>
            <li class="nav-item pt-2">
              <a class="nav-link text-body" data-scroll="" href="#password">
                ...
                <span class="text-sm fuente">Automatizar Matricula</span>
              </a>
            </li>
            <li class="nav-item pt-2">
              <a class="nav-link text-body" data-scroll="" href="#sessions">
                ...
                <span class="text-sm fuente">Otros</span>
              </a>
            </li>
          </ul>
        </div>
