<template>
  <div>
    <vue-editor id="editor" @input="onEditorUpdate"
    :value="value"  :editorToolbar="customToolbar" useCustomImageHandler
 ...
 data (){
   ...
   methods: {
    ...
    handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
      ...
      axios.post("https://uemah.com/api/upload/tareas", formData, {
                            headers: {
