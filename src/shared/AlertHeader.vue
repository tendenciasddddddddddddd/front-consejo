<template>
  <div class="s-header-notification ">
            <div>
             <span class=" s-title-page p-1" > <a @click="$router.go(-1)" v-if="initText" class="text-azul me-2 " style="font-weight: 400;" href="javascript:;"><i class="fas fa-arrow-left"></i>&nbsp; {{initText}}
                &nbsp;
               </a>{{firsttext}}
