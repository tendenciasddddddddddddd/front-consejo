<template>
  <div class="">
              <a v-if="initText" href="javascript:;" @click="$router.go(-1)" class="s-regresar me-2 ms-2 mb-3">
            ...
            Atrás</a>
         <b class="h5 ms-1 " style="color:#000;font-size: 17px;font-weight: 700;">{{firsttext}}</b> <br>
      </div>
</template>
