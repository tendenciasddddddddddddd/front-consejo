<template>
  <div>
    <nav style="box-shadow: none !important;  " class="navbar navbar-main navbar-expand-lg position-sticky
      top-1
      px-0
      mx-4
      border-radius-xl
    ...
    " id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-1">
        ...
        <svg v-if="!$store.state.isAppMobile" aria-label="Vercel Logo" fill="#000" viewBox="0 0 75 65" width="20">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            ...
            <button class="btn btnNaranja" @click="logout">Salir</button>
          </div>
          <ul class="navbar-nav justify-content-end">
            <li class="nav-item dropdown  d-flex align-items-end">
              <a href="javascript:;" class="nav-link text-body p-0">
                <div class="avatar me-1 ">
                  <img :src="$store.state.avatar" alt="kal" class="avatar avatar-sm rounded-circle" />
                </div>
              </a>
            </li>
          </ul>
