...
export default {
  ...
  components: { FullModal: () => import( /* webpackChunkName: "FullModal" */ './FullModal.vue'),
  },
  methods: {
    openNotification(){
